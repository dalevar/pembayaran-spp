<div class="sidebar-wrapper active">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            <li class="sidebar-title text-secondary"><i class="bi bi-dash-lg"></i> Menu</li>
            ...
            <li class="sidebar-title text-secondary"><i class="bi bi-dash-lg"></i> Data Master</li>
            ...
            <li class="sidebar-title text-secondary"><i class="bi bi-dash-lg"></i> Akun</li>
